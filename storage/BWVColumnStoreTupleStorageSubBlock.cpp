...
QUICKSTEP_REGISTER_TUPLE_STORE(BWVColumnStoreTupleStorageSubBlock, BW_V_COLUMN_STORE);
...
BWVColumnStoreTupleStorageSubBlock::BWVColumnStoreTupleStorageSubBlock(
    ...
    //: TupleStorageSubBlock(relation,
      ...
      sort_specified_(description_.HasExtension(
          BWColumnStoreVTupleStorageSubBlockDescription::sort_attribute_id)),
      sorted_(true),
...
bool BWVColumnStoreTupleStorageSubBlock::DescriptionIsValid(
  ...
  if (description.sub_block_type() != TupleStorageSubBlockDescription::BW_V_COLUMN_STORE) {
    return false;
  }
