...
#ifndef QUICKSTEP_STORAGE_BW_COLUMN_STORE_VALUE_ACCESSOR_HPP_
#define QUICKSTEP_STORAGE_BW_COLUMN_STORE_VALUE_ACCESSOR_HPP_
...
class BWColumnStoreValueAccessorHelper {
 public:
  BWColumnStoreValueAccessorHelper(const CatalogRelationSchema &relation,
 ...
 private:
  ...
  DISALLOW_COPY_AND_ASSIGN(BWColumnStoreValueAccessorHelper);
};

typedef PackedTupleStorageSubBlockValueAccessor<
    BWColumnStoreTupleStorageSubBlock,
    BWColumnStoreValueAccessorHelper,
    ValueAccessor::Implementation::kBWColumnStore>
        BWColumnStoreValueAccessor;

}  // namespace quickstep

#endif  // QUICKSTEP_STORAGE_BW_COLUMN_STORE_VALUE_ACCESSOR_HPP_
